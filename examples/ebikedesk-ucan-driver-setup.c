/*
* ebikedesk-ucan-driver-setup.c: Console Driver Installer for a single USB device
 ...
 */
#define DESC        "OpenMoko, Inc. Geschwister Schneider CAN adapter"
#define VID         0x1D50
#define PID         0x606F
#define INF_NAME    "openmoko_inc_geschwister_schneider_can_adapter.inf"
